        ...
        <aside :class="{ 
            ...
            <div class="flex flex-col h-full relative z-10">
                ...
                <nav class="flex-1 py-4 space-y-1 overflow-y-auto scrollbar-thin">
                    ...
                    <div class="space-y-1">
                        <p x-show="$store.sidebar.expanded" class="nav-group-title">Billing</p>
                    ...
                    <div class="flex items-center space-x-2 lg:space-x-4">
                        @if(session('impersonating'))
                            <form action="{{ route('admin.stop-impersonation') }}" method="POST" class="inline">
                                @csrf
                                <button type="submit" class="btn bg-yellow-500 hover:bg-yellow-600 text-white text-sm px-3 py-1.5">
