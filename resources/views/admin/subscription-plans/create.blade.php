...
<div class="space-y-6" x-data="planForm()">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Set up a new pricing plan for customers</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
        <form action="{{ route('admin.subscription-plans.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="pb-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <div class="mt-5">
                    ...
                    <textarea name="description" rows="2" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Brief description of this plan...">{{ old('description') }}</textarea>
                </div>
            </div>
                    ...
                    <div>
                        <label class="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white mb-2">
                            ...
                            <span class="tooltip-wrapper">
                                ...
                                <span class="tooltip-text">Total social accounts user can connect. Use -1 for unlimited.</span>
                            </span>
                        </label>
                    ...
                    <div>
                        <label class="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white mb-2">
                            ...
                            <span class="tooltip-wrapper">
                                ...
                                <span class="tooltip-text">Number of team members allowed. Use -1 for unlimited.</span>
                            </span>
                        </label>
                    ...
                    <div>
                        <label class="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white mb-2">
                            ...
                            <span class="tooltip-wrapper">
                                ...
                                <span class="tooltip-text">Maximum posts in queue at once. Use -1 for unlimited.</span>
                            </span>
                        </label>
            ...
            <div class="pb-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center gap-2 mb-5">
                    ...
                    <span class="tooltip-wrapper">
                        ...
                        <span class="tooltip-text">Choose which platforms are allowed and how many pages per platform</span>
                    </span>
                </div>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="platform_limits[{{ $key }}][max_pages]" value="-1" min="-1"
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" class="bg-indigo-600 text-white px-6 py-2.5 rounded-lg hover:bg-indigo-700 font-medium transition-colors">Create Plan</button>
