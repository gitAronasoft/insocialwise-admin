        ...
        <form action="{{ route('admin.knowledge-base.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" rows="10" required
                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('content') }}</textarea>
            ...
            <div class="flex space-x-3 pt-6">
                <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">Create Article</button>
