    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600">Configure social platform integrations</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.settings.social.update') }}" method="POST" x-data="{ showSecrets: { facebook: false, linkedin: false, twitter: false } }">
        ...
        <div class="space-y-6">
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Connect with Facebook Graph API</p>
                        </div>
                    </div>
                    ...
                    @else
                        <span class="px-2 py-1 text-xs font-semibold rounded-full bg-gray-100 text-gray-600">Not Configured</span>
                    @endif
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input :type="showSecrets.facebook ? 'text' : 'password'" name="facebook_app_secret" value="{{ $socialConfig['facebook_app_secret'] ?? '' }}"
                                ...
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 pr-10 font-mono text-sm">
                            <button type="button" @click="showSecrets.facebook = !showSecrets.facebook" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                ...
                <a href="https://developers.facebook.com/apps" target="_blank" class="inline-flex items-center text-xs text-blue-600 hover:text-blue-800 mt-3">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl p-6 border border-blue-100">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Connect with LinkedIn API</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input :type="showSecrets.linkedin ? 'text' : 'password'" name="linkedin_client_secret" value="{{ $socialConfig['linkedin_client_secret'] ?? '' }}"
                                ...
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 pr-10 font-mono text-sm">
                            <button type="button" @click="showSecrets.linkedin = !showSecrets.linkedin" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                ...
                <a href="https://www.linkedin.com/developers/apps" target="_blank" class="inline-flex items-center text-xs text-blue-600 hover:text-blue-800 mt-3">
                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                    </svg>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-6 border border-gray-200">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Connect with X/Twitter API v2</p>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showSecrets.twitter = !showSecrets.twitter" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                ...
                <a href="https://developer.twitter.com/en/portal/dashboard" target="_blank" class="inline-flex items-center text-xs text-gray-600 hover:text-gray-800 mt-3">
                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                    </svg>
