    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-600">Configure email server for sending notifications</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg flex items-center justify-center"
                     :class="testResult?.success ? 'bg-green-100' : testResult?.success === false ? 'bg-red-100' : 'bg-white'">
                ...
                <div>
                    <p class="font-medium text-gray-900" x-text="testing ? 'Sending test email...' : (testResult?.success ? 'Email Sent Successfully!' : testResult?.success === false ? 'Email Failed' : 'Test Email Delivery')"></p>
                    <p class="text-xs text-gray-500" x-show="lastTested">Last tested: <span x-text="lastTested"></span></p>
                    <p class="text-xs text-gray-500" x-show="!lastTested && !testResult">Send a test email to verify your SMTP configuration</p>
            ...
            <button @click="testEmail()" :disabled="testing"
                class="px-4 py-2 bg-white border border-green-300 rounded-lg text-sm font-medium text-green-700 hover:bg-green-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
        ...
        <div class="border-l-4 border-blue-500 pl-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-gray-500">e.g., smtp.gmail.com, smtp.sendgrid.net</p>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <select name="smtp_port" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <input type="email" name="from_address" value="{{ $emailConfig['from_address'] ?? '' }}"
                        ...
                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    <p class="text-xs text-gray-500">The email address that will appear in the "From" field</p>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="from_name" value="{{ $emailConfig['from_name'] ?? '' }}"
                        ...
                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    <p class="text-xs text-gray-500">The sender name that recipients will see</p>
                </div>
            </div>
        </div>
